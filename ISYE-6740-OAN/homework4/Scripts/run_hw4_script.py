...
from src.hw4controller import HW4Controller
import json
...
def run_model(config):
    ...
    try:
        ...
        model_config = json.loads(config['model_run_parameters']['model_config'])
        num_iterations = json.loads(config['model_run_parameters']['num_iterations'])
        controller = HW4Controller(num_iterations,dataset_names,num_features,model_config)
