...
data <- read.table("C:/Users/mjpearl/Downloads/data 2.2/credit_card_data.txt", stringsAsFactors = FALSE, header = FALSE)

##Load corresponding svm model in matrix form and set scaled to TRUE
##Specifying larger value for C to 200 as the the optimization will choose a smaller-margin hyperplane
##which will improve the model's training compared to a smaller value for C
